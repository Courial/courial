            ...
            <div key={category}>
              ...
              {category === "legal" && (
                <div className="flex flex-col gap-2 mt-4">
                  <a
                    href="#"
                    className="inline-flex items-center gap-2 bg-black text-white px-3 py-1.5 rounded-lg border border-white/30 hover:border-white/50 transition-colors w-fit"
