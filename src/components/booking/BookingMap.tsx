...
function buildInfoContent(address: string, placeName?: string | null): string {
  const style = "font-family:'Avenir','Avenir Next','Nunito Sans',system-ui,sans-serif;font-size:12.5px;font-weight:400;color:rgba(0,0,0,0.75);padding:6px 10px 6px 4px;line-height:1.4;max-width:220px;word-wrap:break-word;white-space:normal;overflow-wrap:break-word;";
  if (placeName) {
