              ...
              >
                ...
                <div className="relative mb-1">
                  <div className="px-4 py-4 border border-border rounded-xl bg-background focus-within:border-border">
                    <textarea
                      placeholder={conciergeCategory === "roadside-assistance" ? "Tell us what's happening and what assistance you need. Include exact location details, urgency level, access instructions, safety notes, tow destination (if applicable), and any relevant contacts or gate codes. Add links if third-party coordination is required." : "Outline the scope of work, preferences, timing requirements, special instructions, relevant contact names and phone numbers, and any external links the Courial will need access to. You may choose to have AI refine your message for clarity and completeness before confirming your booking."}
