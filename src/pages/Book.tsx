                    ...
                    <div className="w-1/2 min-w-0 relative">
                      {roadsideCustomMake ? (
                        ...
                        <>
                          ...
                          >
                            <span className={roadsideVehicleMake ? "text-foreground" : vehicleFieldRedMap.make ? "text-destructive" : "text-muted-foreground"}>{roadsideVehicleMake || (selectedService === "concierge" && conciergeCategory === "roadside-assistance" ? "Service Vehicle" : "Make")}</span>
                    ...
                    {selectedService === "valet" && (
                      <div className="w-1/2 min-w-0">
                        <input
                          ...
                          maxLength={4}
                          className={`w-full min-w-0 px-2 py-2 rounded-lg border border-border/60 bg-background text-foreground text-xs focus:outline-none focus:border-border transition-colors ${vehicleFieldRedMap.year ? "placeholder:text-destructive" : "placeholder:text-muted-foreground"}`}
                        />
                      </div>
                    )}
                      ...
                      <div className="w-1/2 min-w-0 relative">
                        {roadsideCustomModel ? (
                          ...
                          <>
                            ...
                            >
                              <span className={roadsideVehicleModel ? "text-foreground" : vehicleFieldRedMap.model ? "text-destructive" : "text-muted-foreground"}>
                  ...
                  <div className="flex gap-1.5 w-full min-w-0">
                      ...
                      {roadsideCustomColor ? (
                        ...
                        <>
                          <button
                            ...
                            className="w-full px-2 py-2 rounded-lg border border-border/60 bg-background text-foreground text-xs text-left flex items-center justify-between hover:border-foreground/30 transition-colors"
                          >
                            <span className={roadsideVehicleColor ? "text-foreground" : vehicleFieldRedMap.color ? "text-destructive" : "text-muted-foreground"}>{roadsideVehicleColor || "Color"}</span>
                            <ChevronDown className="w-3 h-3 text-muted-foreground" />
                          </button>
                          {roadsideColorOpen && (
                            <div onClick={(e) => e.stopPropagation()} className="absolute z-50 mt-1 w-full max-h-48 overflow-y-auto rounded-lg border border-border/60 bg-background shadow-lg">
                    ...
                    {selectedService === "valet" && (
                      <div className="w-1/3 min-w-0 relative">
                        ...
                        >
                          <span className={roadsidePortType ? "text-foreground" : vehicleFieldRedMap.port ? "text-destructive" : "text-muted-foreground"}>
                    ...
                    <input
                      ...
                      className={`${selectedService === "valet" ? "w-1/3" : "w-1/2"} min-w-0 px-2 py-2 rounded-lg border border-border/60 bg-background text-foreground text-xs focus:outline-none focus:border-border transition-colors ${vehicleFieldRedMap.plate ? "placeholder:text-destructive" : "placeholder:text-muted-foreground"}`}
                    />
                  </div>
                    ...
                    <div className="flex gap-1.5 w-full min-w-0 mt-1.5">
                      ...
                      <div className="w-1/2 min-w-0 relative">
                        <button
                          ...
                          className="w-full px-2 py-2 rounded-lg border border-border/60 bg-background text-foreground text-xs text-left flex items-center justify-between hover:border-foreground/30 transition-colors"
                        >
                          <span className={batteryCurrentCharge ? "text-foreground" : vehicleFieldRedMap.currentCharge ? "text-destructive" : "text-muted-foreground"}>{batteryCurrentCharge ? `${batteryCurrentCharge}%` : "Current Charge"}</span>
                          <ChevronDown className="w-3 h-3 text-muted-foreground" />
                        </button>
                        {batteryCurrentOpen && (
                          <div onClick={(e) => e.stopPropagation()} className="absolute z-50 mt-1 w-full max-h-48 overflow-y-auto rounded-lg border border-border/60 bg-background shadow-lg">
                      ...
                      <div className="w-1/2 min-w-0 relative">
                        <button
                          ...
                          className="w-full px-2 py-2 rounded-lg border border-border/60 bg-background text-foreground text-xs text-left flex items-center justify-between hover:border-foreground/30 transition-colors"
                        >
                          <span className={batteryTargetCharge ? "text-foreground" : vehicleFieldRedMap.finalCharge ? "text-destructive" : "text-muted-foreground"}>{batteryTargetCharge ? `${batteryTargetCharge}%` : "Final Charge Request"}</span>
                          <ChevronDown className="w-3 h-3 text-muted-foreground" />
                        </button>
                        {batteryTargetOpen && (
                          <div onClick={(e) => e.stopPropagation()} className="absolute z-50 mt-1 w-full max-h-48 overflow-y-auto rounded-lg border border-border/60 bg-background shadow-lg">
