  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        >
          <div className="rounded-3xl bg-foreground text-background px-8 py-6 relative shadow-2xl inline-flex flex-col items-center">
            {/* Back arrow */}
                ...
                >
                  <form onSubmit={handleSignInSendOtp} className="space-y-3">
                    ...
                    <div className="flex justify-center">
                      <Button type="submit" disabled={loading} className="rounded-full h-11 px-6 text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90">
